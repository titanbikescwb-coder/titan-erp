    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <CardPadrao
          ...
          value={retentionLeads.length}
          icon={Users}
          iconColor="text-blue-400"
          iconBgColor="bg-blue-400/10"
        />
        <CardPadrao
          title="Média Dias Ausentes"
          value={retentionLeads.length > 0 ? Math.floor(retentionLeads.reduce((a, b) => a + b.daysSinceLastVisit, 0) / retentionLeads.length) : 0}
          icon={History}
