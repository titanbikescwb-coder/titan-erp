    ...
    <div className="space-y-10 px-4 md:px-8 pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
        ...
        >
          <div className="flex items-center gap-4 mb-2">
            ...
            <h1 className="text-4xl font-black text-white tracking-wider uppercase leading-none">
              DRE Gerencial
            </h1>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <CardPadrao
          ...
          isPercentage
          indicator={data.margemLiquida}
          indicatorColor={data.margemLiquida >= 20 ? 'bg-emerald-500' : 'bg-amber-500'}
          icon={data.margemLiquida >= 15 ? TrendingUp : TrendingDown}
          iconColor={data.margemLiquida >= 15 ? 'text-emerald-500' : 'text-rose-500'}
          iconBgColor={data.margemLiquida >= 15 ? 'bg-emerald-500/10' : 'bg-rose-500/10'}
          onClick={() => toast(`Margem líquida atual: ${data.margemLiquida.toFixed(1)}%`)}
        />
        ...
        <CardPadrao
          ...
          isCurrency
          subValue="Resultado Final"
          icon={DollarSign}
          iconColor="text-titan-primary"
          iconBgColor="bg-titan-primary/10"
          onClick={() => toast(`Lucro líquido do período: ${formatCurrency(data.lucroLiquido)}`)}
        />
        ...
        <CardPadrao
          ...
          icon={BarChart3}
          iconColor="text-titan-primary"
          onClick={() => toast('Eficiência operacional: análise entre custos fixos e variáveis.')}
        >
