            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <section className="card-premium p-10 rounded-[40px] border border-titan-border shadow-[0_40px_100px_rgba(0,0,0,0.6)] space-y-8">
                <div className="flex items-center gap-4 pb-6 border-b border-white/5">
                  ...
                  <div>
                    <h3 className="text-xl font-black text-white uppercase tracking-tighter">Formas de Pagamento</h3>
                    <p className="text-[9px] text-white font-black uppercase tracking-[0.2em] opacity-40">Gestão de recebíveis</p>
                  </div>
                </div>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {formData.paymentMethods.map((method, idx) => (
                      <div key={idx} className="flex items-center gap-3 px-5 py-2.5 bg-black/40 border border-titan-border rounded-xl group hover:border-emerald-500/30 transition-all">
                        <span className="text-[10px] font-black text-white uppercase tracking-widest">{method}</span>
                        <button 
                          type="button"
              ...
              <section className="card-premium p-10 rounded-[40px] border border-titan-border shadow-[0_40px_100px_rgba(0,0,0,0.6)] space-y-8">
                <div className="flex items-center gap-4 pb-6 border-b border-white/5">
                  ...
                  <div>
                    <h3 className="text-xl font-black text-white uppercase tracking-tighter">Categorias</h3>
                    <p className="text-[9px] text-white font-black uppercase tracking-[0.2em] opacity-40">Classificação de estoque</p>
                  </div>
                </div>
          ...
          <form onSubmit={handleSave} className="space-y-10">
            ...
            <section className="card-premium p-10 rounded-[40px] border border-titan-border shadow-[0_40px_100px_rgba(0,0,0,0.6)] space-y-10">
              <div className="flex items-center justify-between pb-6 border-b border-white/5">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-xl font-black text-white uppercase tracking-tighter">Perfil da Empresa</h3>
                    <p className="text-[9px] text-white font-black uppercase tracking-[0.2em] opacity-40">Dados cadastrais e fiscais</p>
                  </div>
                </div>
                {!certificate && (
                  <Button 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="md:col-span-2 flex flex-col md:flex-row items-start md:items-center gap-10 bg-black/20 p-8 rounded-[32px] border border-titan-border shadow-inner">
                  <div className="relative group self-center md:self-auto">
                    <div className="w-32 h-32 rounded-[28px] bg-black/40 border-2 border-dashed border-white/10 flex items-center justify-center overflow-hidden transition-all group-hover:border-indigo-500/50">
                      {formData.logoUrl ? (
                        <img src={formData.logoUrl} alt="Logo" className="w-full h-full object-contain p-4" referrerPolicy="no-referrer" />
                      ) : (
                  ...
                  <div className="flex-1 w-full space-y-4">
                    <div className="flex items-center justify-between">
                      <label className="text-[10px] font-black text-white uppercase tracking-[0.2em]">URL da Logo</label>
                      {formData.logoUrl && (
                        <Button 
                          variant="ghost"
                          size="sm"
                ...
                <div className="md:col-span-2">
                  <label className="text-[10px] font-black text-white uppercase tracking-[0.2em] mb-3 block">Razão Social / Nome Fantasia</label>
                  <input
                    type="text" required
                    value={formData.name}
                ...
                <div>
                  <label className="text-[10px] font-black text-white uppercase tracking-[0.2em] mb-3 block">CNPJ</label>
                  <input
                    type="text"
                    value={formData.cnpj}
                ...
                <div>
                  <label className="text-[10px] font-black text-white uppercase tracking-[0.2em] mb-3 block">Telefone Comercial</label>
                  <input
                    type="text"
                ...
                <div className="md:col-span-2">
                  <label className="text-[10px] font-black text-white uppercase tracking-[0.2em] mb-3 block">E-mail Corporativo</label>
                  <input
                    type="email"
                ...
                <div className="md:col-span-2 pt-10 border-t border-white/5">
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <h4 className="text-[10px] font-black text-white uppercase tracking-[0.4em]">LOCALIZAÇÃO COMERCIAL</h4>
                  </div>
                  
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="md:col-span-1">
                      <label className="text-[10px] font-black text-white uppercase tracking-[0.2em] mb-3 block">CEP / POSTAL</label>
                      <div className="relative">
                        ...
                        />
                        {cepLoading && <Loader2 className="absolute right-4 top-4 w-4 h-4 text-indigo-500 animate-spin" />}
                      </div>
                    </div>
                    <div className="md:col-span-2">
                      <label className="text-[10px] font-black text-white uppercase tracking-[0.2em] mb-3 block">Logradouro / Avenida</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="text-[10px] font-black text-white uppercase tracking-[0.2em] mb-3 block">Número</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="text-[10px] font-black text-white uppercase tracking-[0.2em] mb-3 block">Bairro</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="text-[10px] font-black text-white uppercase tracking-[0.2em] mb-3 block">Cidade / Estado</label>
                      <input
                        type="text"
            ...
            <section className="card-premium p-10 rounded-[40px] border border-titan-border shadow-[0_40px_100px_rgba(0,0,0,0.6)] space-y-10">
              <div className="flex items-center gap-4 pb-6 border-b border-white/5">
                ...
                <div>
                  <h3 className="text-xl font-black text-white uppercase tracking-tighter">Recibo & Visual</h3>
                  <p className="text-[9px] text-white font-black uppercase tracking-[0.2em] opacity-40">Identidade visual e automações</p>
                </div>
              </div>
              
              <div className="space-y-8">
                <div>
                  <label className="text-[10px] font-black text-white uppercase tracking-[0.2em] mb-3 block">Mensagem Personalizada de Rodapé</label>
                  <textarea
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <label className="flex items-center justify-between p-6 rounded-3xl bg-black/20 border border-titan-border hover:bg-black/30 transition-all cursor-pointer">
                    <div className="flex flex-col">
                      <span className="text-[10px] font-black text-white uppercase tracking-widest leading-none mb-1">CNPJ no Recibo</span>
                      <span className="text-[10px] text-white/30 uppercase font-bold tracking-tight">Exibir em cabeçalho</span>
                    </div>
                    <input
                      type="checkbox"
                  ...
                  <label className="flex items-center justify-between p-6 rounded-3xl bg-black/20 border border-titan-border hover:bg-black/30 transition-all cursor-pointer">
                    <div className="flex flex-col">
                      <span className="text-[10px] font-black text-white uppercase tracking-widest leading-none mb-1">Endereço no Recibo</span>
                      <span className="text-[10px] text-white/30 uppercase font-bold tracking-tight">Exibir em rodapé</span>
                    </div>
                    <input
                      type="checkbox"
          ...
          <div className="space-y-10">
            ...
            {certificate ? (
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
                  <div className="flex items-center gap-6">
                    <div className={cn(
                      ...
                      certificate.status === 'válido' ? "bg-emerald-600/20 border-emerald-500/30 text-emerald-400" : "bg-red-600/20 border-red-500/30 text-red-500"
                    )}>
                      {certificate.status === 'válido' ? <ShieldCheck className="w-10 h-10" /> : <ShieldAlert className="w-10 h-10" />}
                    </div>
                    <div>
                      <h3 className="text-2xl font-black text-white uppercase tracking-tighter mb-1">
                        Certificado {certificate.status === 'válido' ? 'Ativo' : 'Expitado/Inválido'}
                      </h3>
                  ...
                  <div className="flex flex-col items-end gap-2 bg-black/20 p-6 rounded-3xl border border-white/5">
                    <span className="text-[10px] font-black text-white/30 uppercase tracking-widest">Validade</span>
                    <div className="flex items-center gap-3">
                      <p className="text-sm font-black text-white">{new Date(certificate.validFrom).toLocaleDateString()}</p>
                      <div className="w-4 h-px bg-white/10" />
                      <p className="text-sm font-black text-white">{new Date(certificate.validTo).toLocaleDateString()}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10 p-8 bg-white/5 rounded-[32px] border border-white/5">
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      ...
                      <span className="text-[10px] font-black text-white/40 uppercase tracking-widest">Emissor</span>
                    </div>
                    <p className="text-xs font-bold text-white uppercase tracking-tight">{certificate.issuer}</p>
                  </div>
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      <Save className="w-4 h-4 text-titan-primary" />
                      <span className="text-[10px] font-black text-white/40 uppercase tracking-widest">Última atualização</span>
                    </div>
                    <p className="text-xs font-bold text-white uppercase tracking-tight">
                      {certificate.updatedAt?.toDate ? certificate.updatedAt.toDate().toLocaleString() : 'Recém carregado'} por {certificate.updatedBy}
                    </p>
                  </div>
                </div>
              </motion.section>
              ...
              <section className="card-premium p-10 rounded-[40px] border border-titan-border shadow-[0_40px_100px_rgba(0,0,0,0.6)] text-center space-y-6">
                ...
                <div>
                  <h3 className="text-2xl font-black text-white uppercase tracking-tighter">Nenhum Certificado Configurado</h3>
            ...
            <section className="card-premium p-10 rounded-[40px] border border-titan-border shadow-[0_40px_100px_rgba(0,0,0,0.6)] space-y-10">
              <div className="flex items-center gap-4 pb-6 border-b border-white/5">
                ...
                <div>
                  ...
                  <p className="text-[9px] text-white font-black uppercase tracking-[0.2em] opacity-40">Extensão .p12 ou .pfx</p>
                </div>
              </div>
              ...
              <form onSubmit={handleCertUpload} className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-4">
                    <label className="text-[10px] font-black text-white uppercase tracking-[0.2em] ml-1 block">Arquivo do Certificado</label>
                  ...
                  <div className="space-y-4">
                    <label className="text-[10px] font-black text-white uppercase tracking-[0.2em] ml-1 block">Senha do Certificado</label>
                    <div className="relative group">
              ...
              <div className="p-6 bg-amber-500/5 border border-amber-500/10 rounded-2xl space-y-3">
                <div className="flex items-center gap-2 text-amber-500">
                  ...
                  <span className="text-[10px] font-black uppercase tracking-widest">Segurança & Criptografia</span>
                </div>
